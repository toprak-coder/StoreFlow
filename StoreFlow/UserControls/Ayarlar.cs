...
namespace StoreFlow
{
    public partial class Ayarlar : UserControl
    {
        ...
        private static string GetConnectionStringFromAppData()
        {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else if (!NameBool && !OldPasswdBool && NewPasswdBool)
                {
                    ...
                    _userData.kullaniciadi = Name; // kullanıcı adını güncelle
                }
                else if (!NameBool && !OldPasswdBool && !NewPasswdBool)
                {
                ...
                int affectedRows = 0;
                using (SqlConnection con = new SqlConnection(GetConnectionStringFromAppData()))
                {
                    con.Open();
